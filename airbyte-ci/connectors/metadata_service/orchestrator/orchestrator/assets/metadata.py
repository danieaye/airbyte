...
def get_metadata_entries(blob_resource) -> List[LatestMetadataEntry]:
    metadata_entries = []
...
def latest_metadata_entries(context: OpExecutionContext) -> List[LatestMetadataEntry]:
...
@sentry.instrument_asset_op
def release_candidate_metadata_entries(context: OpExecutionContext) -> List[LatestMetadataEntry]:
